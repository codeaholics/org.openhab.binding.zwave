...
public class RequestNetworkUpdateMessageClass extends ZWaveCommandProcessor {
    ...
    public ByteMessage doRequest() {
        ...
        // Queue the request
        ByteMessage newMessage = new ByteMessage(MessageClass.RequestNetworkUpdate, ByteMessageType.Request,
                MessageClass.RequestNetworkUpdate, ByteMessagePriority.High);
