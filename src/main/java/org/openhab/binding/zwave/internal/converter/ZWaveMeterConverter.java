...
public class ZWaveMeterConverter extends ZWaveCommandClassConverter {
    ...
    public List<ByteMessage> receiveCommand(ZWaveThingChannel channel, ZWaveNode node, Command command) {
        ...
        ByteMessage serialMessage = node.encapsulate(commandClass.getResetMessage(), commandClass,
                channel.getEndpoint());
        ...
        // And poll the device
        for (ByteMessage serialGetMessage : commandClass.getDynamicValues(true)) {
