...
public class RemoveNodeMessageClass extends ZWaveCommandProcessor {
    ...
    public ByteMessage doRequestStart() {
        logger.debug("Setting controller into EXCLUSION mode.");

        // Queue the request
        ByteMessage newMessage = new ByteMessage(ByteMessage.MessageClass.RemoveNodeFromNetwork,
                ByteMessage.ByteMessageType.Request, ByteMessage.MessageClass.RemoveNodeFromNetwork,
