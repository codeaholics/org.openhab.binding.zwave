...
public class RemoveFailedNodeMessageClass extends ZWaveCommandProcessor {
    ...
    public ByteMessage doRequest(int nodeId) {
        ...
        // Queue the request
        ByteMessage newMessage = new ByteMessage(MessageClass.RemoveFailedNodeID, ByteMessageType.Request,
                MessageClass.RemoveFailedNodeID, ByteMessagePriority.High);
