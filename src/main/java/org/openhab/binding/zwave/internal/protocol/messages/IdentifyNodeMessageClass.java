...
public class IdentifyNodeMessageClass extends ZWaveCommandProcessor {
    ...
    public ByteMessage doRequest(int nodeId) {
        ByteMessage newMessage = new ByteMessage(MessageClass.IdentifyNode, ByteMessageType.Request,
                MessageClass.IdentifyNode, ByteMessagePriority.High);
    ...
    public boolean handleResponse(ZWaveController zController, ByteMessage lastSentMessage,
        ...
        if (lastSentMessage.getMessageClass() != MessageClass.IdentifyNode) {
