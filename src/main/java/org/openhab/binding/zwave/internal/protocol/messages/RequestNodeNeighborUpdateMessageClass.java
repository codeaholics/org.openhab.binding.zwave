...
public class RequestNodeNeighborUpdateMessageClass extends ZWaveCommandProcessor {
    ...
    public ByteMessage doRequest(int nodeId) {
        ...
        // Queue the request
        ByteMessage newMessage = new ByteMessage(MessageClass.RequestNodeNeighborUpdate,
                ByteMessageType.Request, MessageClass.RequestNodeNeighborUpdate, ByteMessagePriority.High);
