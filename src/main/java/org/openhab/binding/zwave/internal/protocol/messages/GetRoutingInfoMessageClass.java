...
public class GetRoutingInfoMessageClass extends ZWaveCommandProcessor {
    ...
    public ByteMessage doRequest(int nodeId) {
        ...
        // Queue the request
        ByteMessage newMessage = new ByteMessage(ByteMessage.MessageClass.GetRoutingInfo,
                ByteMessage.ByteMessageType.Request, ByteMessage.MessageClass.GetRoutingInfo,
