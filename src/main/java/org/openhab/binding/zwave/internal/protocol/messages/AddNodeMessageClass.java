...
public class AddNodeMessageClass extends ZWaveCommandProcessor {
    ...
    public ByteMessage doRequestStart(boolean highPower, boolean networkWide) {
        logger.debug("Setting controller into INCLUSION mode, highPower:{} networkWide:{}.", highPower, networkWide);

        // Queue the request
        ByteMessage newMessage = new ByteMessage(ByteMessage.MessageClass.AddNodeToNetwork,
                ByteMessage.ByteMessageType.Request, ByteMessage.MessageClass.AddNodeToNetwork,
                ByteMessage.ByteMessagePriority.High);
    ...
    public ByteMessage doRequestStop() {
